...
class SmartmediaClip_text extends XoopsObject {
    ...
    */		
	function SmartmediaClip_text($id = null) 
	{
        ...
        $this->initVar("block_title", XOBJ_DTYPE_TXTBOX, null, false, 100);
	...
	/**
	 * @return string block_title of this clip (used in the List of Clips block)
	 */	     
	function block_title($format="S")
    {
    	return $this->getVar("block_title", $format);
    }	
	...
	*/
	function insert(&$obj, $force = false)
	{
		...
		if ($obj->isNew()) {
			...
			$this->_db->quoteString($block_title), 
