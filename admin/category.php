...
function editcat($showmenu = false, $categoryid = 0)
{
	...
	// title
	$sform->addElement(new XoopsFormText(_AM_SMEDIA_CATEGORY, 'title', 50, 255, $categoryObj->title('e')), true);
...
function editcat_text($showmenu = false, $categoryid, $languageid)
{
	...
	// title
	$sform->addElement(new XoopsFormText(_AM_SMEDIA_CATEGORY, 'title', 50, 255, $categoryObj->title()), true);
