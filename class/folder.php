    ...
    function &get($id, $languageid='current')
    {
    	...
    	if($id > 0) {
            ...
            if($numrows == 1) {
                ...
                // Check to see if the categoryid is in the url and change it only of we are in admin side
                if (strpos(xoops_getenv('PHP_SELF'), 'admin/folder.php') > 0) {
