...
//patch pour commentaires
$folderid = $folderid != 0 ? $folderid : $theClipObj->getVar('folderid');
//fin patch pour commentaires
$folderObj = $smartmedia_folder_handler->get($folderid);

$folderObj->setVar('categoryid', $categoryid);
//patch pour commentaires
$categoryid = $categoryid != 0 ? $categoryid : $folderObj->getVar('categoryid');
//var_dump($folderObj->getVar('categoryid'));exit;
//fin patch pour commentaires
...
$browser = smartmedia_browser_detection( 'browser' );
...
$xoopsTpl->assign('lang_see_presentation', _MD_SMEDIA_SEE_PRESENTATION);
...
$xoopsTpl->_tpl_vars['commentsnav'] = str_replace("comment_new.php?", "comment_new.php?folderid=$folderid&categoryid=$categoryid&", $xoopsTpl->_tpl_vars['commentsnav']);
