...
define('_AM_SMEDIA_DB_NEEDUPDATE', 'Your database is out-of-date. Please upgrade your database tables!<br><b>Note : The SmartFactory strongly recommends you to backup all SmartMedia tables before running this upgrade script.</b><br>');
...
define("_AM_SMEDIA_CLIP_BLOCK_TITLE", "Block title");
define("_AM_SMEDIA_CLIP_BLOCK_TITLE_DSC", "Title of the clip in the List of clips block.");
...
define("_AM_SMEDIA_CLIP_PRESENTATION_FILE", "Presentation file");
define("_AM_SMEDIA_CLIP_PRESENTATION_FILE_DSC", "Note that if you are using a presentation file, you will not be able to use the tabs below.");
define("_AM_SMEDIA_CLIP_PRESENTATION_FORMATID", "Format of the presentation file");
